    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav_logo">Anik Roy</a>
                ...
                <div className={Toggle ? "nav_menu show_menu" : "nav_menu"}>
                    <ul className="nav_list grid">
                        ...
                        <li className="nav_item">
                            <a href="#courses" onClick={() => setActiveNav("#courses")} className={activeNav === "#courses" ? "nav_link active-link" : "nav_link"} >
                                <i className="uil uil-briefcase-alt nav_icon"></i> Courses
                            </a>
                        </li>
                ...
                <div className="nav nav_toggle" onClick={() => showMenu(!Toggle)}>
