...
import useTypewriter from "../../utility/useTypewriter";

const titles = ["a Web Developer", "an App Developer", "a Competitive Coder", "Anik Roy"];
const typingSpeed = 100;
const deletingSpeed = 50;
const pauseDuration = 1000;

const Data = () => {
    const { text } = useTypewriter(titles, typingSpeed, deletingSpeed, pauseDuration);
    return (
        <div className="home_data">
            ...
            <h3 className="home_subtitle">
                {text}<span className="flicker-animation">|</span>
            </h3>
            <p className="home_description">
                Final year student from GLA University pursuing BTech in Computer Science and Engineering.
            </p>
