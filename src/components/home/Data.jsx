...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Anik Roy
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">Final year student from GLA University pursuing BTech in Computer Science and Engineering.</p>
